    ...
    <div className="flex flex-col gap-6">
      ...
      <Section title="Study">
        ...
        <Row label="Shuffle cards">
          ...
          >
            <span className={`absolute top-0.5 left-0.5 w-5 h-5 bg-parchment dark:bg-ink rounded-full shadow transition-transform duration-200 ${settings.shuffle ? 'translate-x-5' : 'translate-x-0'}`} />
          </button>
        </Row>
      </Section>
      ...
      <Section title="About">
        <p className="text-sm text-ink/55 dark:text-parchment/55 font-body">
          Kairos v0.3 · Spaced repetition powered by SM-2 · Data stored locally in your browser.
        </p>
      </Section>
    </div>
  )
